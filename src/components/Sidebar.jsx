...
function Sidebar() {
  ...
  const navItems = [
    ...
    { to: "/ambulance-tracker", label: "Ambulance Tracker", icon: MapPin },
    { to: "/medicines", label: "Medicines", icon: Pill },
    { to: "/doctors", label: t("doctors"), icon: Stethoscope },
    { to: "/hospitals", label: t("hospitals"), icon: Building2 },
    { to: "/bloodbanks", label: "Blood Banks", icon: Droplets },
    { to: "/donors", label: "Donors", icon: HandHeart },
    { to: "/request-blood", label: "Request Blood", icon: Activity },
